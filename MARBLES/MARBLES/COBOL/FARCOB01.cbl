       ...
       PROGRAM-ID. FARCOB01.                                                    
      ******************************************************************        
      *REMARKS.  BATCH COBOL - CALLS FARSUB02 WHICH SHOULD BE LINKED            
      *          FROM THE OBJECT LIBRARY.                                       
      *          - USES LINKCARD FARCOB01.                                      
      *          - CAN BE COMPILED INTO OBJECT LIB USING CIINBO/CLENBO          
      *            AND LATER LINKED WITH LNKNBL.                                
      *          - ALSO: CAN BE COMPILED AND LINKED WITH CIINBL.                
      ******************************************************************        
      ...
      ******************************************************************        
           ...
           PERFORM WRITE-AND-READ                                               
              UNTIL END-OF-FILE.                                                
           CALL 'FARSUB02' USING COPY1-BOOK.                                    
           CLOSE INPUT-FILE                                                     
                 REPORT-FILE.                                                   
           GOBACK.                                                              
      ******************************************************************        
