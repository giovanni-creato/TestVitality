      * ===============================================================         
      * The user invokes this transaction (called MB15) via:                    
      *   MB15 <VERB>                                                           
      *                                                                         
      * Where:                                                                  
      *   <VERB> = CRE|UPD|DEL                                                  
      ...
      *                                                                         
      * CREate                                                                  
      *  Invoked via MB15 CRE <COLOR> <INVENTORY> <COST>                        
      *                                                                         
      *  Where:                                                                 
      ...
      *                                                                         
      *  Example:                                                               
      *   MB15 CRE LAVENDER 10 4                                                
      *                                                                         
      * UPDate                                                                  
      *  Invoked via MB15 UPD <COLOR> <INVENTORY> <COST>                        
      *                                                                         
      *  Where:                                                                 
      ...
      *                                                                         
      *  Example:                                                               
      *   MB15 UPD LAVENDER 1 5                                                 
      *                                                                         
      * DELete                                                                  
      *  Invoked via MB15 DEL <COLOR>                                           
      *                                                                         
      *  Where:                                                                 
      *   <COLOR>     A marble color defined in EVENT.MARBLE                    
      *                                                                         
