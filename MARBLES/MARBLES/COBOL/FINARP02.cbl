   ...
   *****  MODIFIED IN SMPLTEST/T/FINANCE/ACCTREC/COBOL                          
       FILE-CONTROL.                                                            
      ...
      ******************************************************************        
       ...
       01  DATA-LINE.                                                           
           ...
           02  FILLER                PIC X(5).                                  
           02  OUTPUT-TOTAL          PIC ZZZ,ZZZ,ZZZ,ZZ9.                       
           02  FILLER                PIC X(33).                                 
      ******************************************************************        
       PROCEDURE DIVISION.                                                      
...
********** CALL 'FINARS01'.                                                     
      ...
      ******************************************************************        
       WRITE-REPORT-LINE.                                                       
           ...
           COMPUTE OUTPUT-TOTAL = INPUT-FIELD4 + INPUT-FIELD5.                  
      ...
      ******************************************************************        
       WRITE-HEADER.                                                            
           ...
           ADD 1 TO PAGE-COUNT                                                  
           MOVE '        PROGX REPORT          '   TO REPORT-TITLE.             
